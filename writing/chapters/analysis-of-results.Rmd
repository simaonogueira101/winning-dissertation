...
stargazer(
  ...
  type = table_output,
  title = "Accelerator Program Design Variables: Summary Statistics.",
  header = FALSE,
...
stargazer(
  md_backgrounds_desc,
  type = table_output,
  title = "Accelerator Founding Managing Director Backgrounds: Summary Statistics.",
  header = FALSE,
...
stargazer(
  ...
  summary = FALSE,
  type = table_output,
  title = "Accelerator Founding Managing Director Backgrounds: Correlation.",
  header = FALSE,
  single.row = TRUE,
  font.size = table_font_size,
  column.sep.width = "1pt",
...
stargazer(
  ...
  type = table_output,
  title = "Accelerator Founding Sponsors: Summary Statistics.",
  header = FALSE,
...
stargazer(
  ...
  summary = FALSE,
  type = table_output,
  title = "Accelerator Founding Sponsors: Correlation.",
  header = FALSE,
  single.row = TRUE,
  font.size = table_font_size,
  column.sep.width = "1pt",
...
stargazer(
  ...
  type = table_output,
  title = "Accelerator Company Performance: Summary Statistics.",
  header = FALSE,
...
stargazer(
  ...
  acc_spon_md_back_m4,
  type = table_output,
  title = "Accelerator Founding Sponsors and Accelerator Founding Managing Director Backgrounds.",
  header = FALSE,
...
stargazer(
  ...
  type = table_output,
  title = "Background of Accelerator Founding Managing Directors Backgrounds and Accelerator Program Design Variables.",
  header = FALSE,
...
stargazer(
  ...
  type = table_output,
  title = "Accelerator Founding Sponsors and Accelerator Program Design Variables.",
  header = FALSE,
  dep.var.labels = founding_sponsors_verbose,
  covariate.labels = if(knit_type == "latex"){acc_design_choices_verbose} else {acc_design_choices_verbose_html},
  single.row = TRUE,
...
stargazer(
  ...
  type = table_output,
  title = "Ill-Designed Accelerator: Summary Statistics.",
  header = FALSE,
...
stargazer(
  ...
  type = table_output,
  title = "Well-Designed Accelerator: Summary Statistics.",
  header = FALSE,
  covariate.labels = if(knit_type == "latex"){acc_design_choices_complete_verbose} else {acc_design_choices_complete_verbose_html},
  single.row = TRUE,
  font.size = "tiny",
